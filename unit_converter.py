# PSEUDOCODE
# First of all ask the general type of the unit you want to convert (e.g. temp, currency, volume, mass)
# Then ask the type of the unit you want to give
# Then ask the type of the unit you want to convert into
# Then take the number
# After that make the necessary calculations to convert
